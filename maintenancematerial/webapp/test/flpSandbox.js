		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "[SYNC YOUNG - MM] 자재 관리",
									"targetURL": "#cl3syncyoungmmmtmmaintenancematerial-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"cl3syncyoungmmmtmmaintenancematerial-display": {
								"semanticObject": "cl3syncyoungmmmtmmaintenancematerial",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=cl3.syncyoung.mm.mtm.maintenancematerial",
									"url": sap.ui.require.toUrl("cl3/syncyoung/mm/mtm/maintenancematerial")
								}
							}
						}
					}
