		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "[SYNC YOUNG - MM] 자재관리",
									"targetURL": "#cl3syncyoungmmmaterialcrudmaterialcrud-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"cl3syncyoungmmmaterialcrudmaterialcrud-display": {
								"semanticObject": "cl3syncyoungmmmaterialcrudmaterialcrud",
								"action": "display",
								"description": "[SYNC YOUNG - MM] 자재관리",
								"title": "[SYNC YOUNG - MM] 자재관리",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=cl3.syncyoung.mm.materialcrud.materialcrud",
									"url": sap.ui.require.toUrl("cl3/syncyoung/mm/materialcrud/materialcrud")
								}
							}
						}
					}
