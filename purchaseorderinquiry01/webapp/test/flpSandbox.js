		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "[SYNC YOUNG - MM] 구매오더조회",
									"targetURL": "#cl3syncyoungpipurchaseorderinquiry01-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"cl3syncyoungpipurchaseorderinquiry01-display": {
								"semanticObject": "cl3syncyoungpipurchaseorderinquiry01",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=cl3syncyoungpi.purchaseorderinquiry01",
									"url": sap.ui.require.toUrl("cl3syncyoungpi/purchaseorderinquiry01")
								}
							}
						}
					}
